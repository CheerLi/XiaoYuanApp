...
public class RestApi extends TreeMap<String, String> {
	...
	public final static String APK_ID = "4503338";
	public final static String API_KEY = "UUNrvCPo2WAc1zjEr3umKIZr";
	public final static String SECRET_KEY = "FIYUP39gj2wGvRWpyIWNakDxHmixdARl";

	public final static String PUSH_MESSAGE_URL = "http://channel.api.duapp.com/rest/2.0/channel/channel";
	public final static String FETCH_MESSAGE_URL = "https://channel.api.duapp.com/rest/2.0/channel/channel";
	public final static String QUERY_BIND_LIST_URL = "";
